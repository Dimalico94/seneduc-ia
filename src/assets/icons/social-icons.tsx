...
const baseStyles = (sx?: SxProps<Theme>, width?: number | string) => {
  const color = (sx as SxProps<Theme> & { color?: string })?.color;
...
export const LinkedinIcon = forwardRef<SVGSVGElement, SvgIconProps>(
...
export const FacebookIcon = forwardRef<SVGSVGElement, SvgIconProps>(
  ({ width = 20, sx, ...other }, ref) => (
    <SvgIcon ref={ref} sx={{ ...baseStyles(sx, width) }} {...other}>
      <path
        fill="#1877F2"
...
export const GithubIcon = forwardRef<SVGSVGElement, SvgIconProps>(
  ({ width = 20, sx, ...other }, ref) => (
    <SvgIcon ref={ref} sx={{ ...baseStyles(sx, width) }} {...other}>
      <path
        fill="currentColor"
...
export const TwitterIcon = forwardRef<SVGSVGElement, SvgIconProps>(
  ({ width = 20, sx, ...other }, ref) => (
    <SvgIcon ref={ref} sx={{ ...baseStyles(sx, width) }} {...other}>
      <path
        fill="currentColor"
...
export const GoogleIcon = forwardRef<SVGSVGElement, SvgIconProps>(
  ({ width = 20, sx, ...other }, ref) => (
    <SvgIcon ref={ref} sx={{ ...baseStyles(sx, width) }} {...other}>
      <path
        fill="#FFC107"
...
export const ReturnTopPageIcon = forwardRef<SVGSVGElement, SvgIconProps>(
  ({ width = 24, sx, ...other }, ref) => (
    <SvgIcon ref={ref} sx={{ ...baseStyles(sx, width) }} {...other}>
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <rect y="-0.00195312" width="24" height="24" rx="12" fill="white" />
        <path
          d="M5.5 12.748L12 6.24805L18.5 12.748M5.5 17.948L12 11.448L18.5 17.948"
          stroke="#004B86"
          strokeWidth="1.5"
          strokeLinecap="round"
