...
export type LogoMainProps = BoxProps & {
  href?: string;
  isSingle?: boolean;
  disableLink?: boolean;
};

export const LogoMain = forwardRef<HTMLDivElement, LogoMainProps>(
  (
    ...
    const singleLogo = (
      ...
      >
        <Box width={{ xs: 40, sm: 50, lg: 70 }}>
          ...
          >
            <rect
              ...
              height="33.9823"
              rx="10.6195"
              transform="rotate(45 24.4854 0.970703)"
              fill="#004B86"
            />
            <rect
              x="48.5146"
              ...
              height="33.9823"
              rx="10.6195"
              transform="rotate(45 48.5146 0.970703)"
              fill="#30CB70"
            />
          </svg>
        </Box>
        ...
        >
          sen<span style={{ letterSpacing: -5.31 }}>Educ.</span>
        </Typography>
      </Box>
    );
